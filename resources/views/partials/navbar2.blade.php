...
<nav class="navbar navbar-expand-lg navbar-light" id="navbar">
                  ...
                  <div id="carouselEvent" class="carousel carousel-dark slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                          <div class="carousel-item active">
                              <div class="card-wrapper">
                                  <div class="card-events" data-bs-toggle="modal" data-bs-target="#cardEvent">
                                      <img class="img-events img-fluid card-img-top2" alt="" src="img/event/panen-terong.jpg">
                                      <div class="card-body">
                                  ...
                                  <div class="card-events">
                                      <img class="img-events img-fluid card-img-top2" alt="" src="img/event/pohon-kelapa.jpg">
                                      <div class="card-body">
                                  ...
                                  <div class="card-events">
                                      <img class="img-events img-fluid card-img-top2" alt="" src="img/event/perawatan-kebun.jpg">
                                      <div class="card-body">
                          ...
                          <div class="carousel-item">
                              <div class="card-wrapper">
                                  <div class="card-events">
                                      <img class="img-events img-fluid card-img-top2" alt="" src="img/event/masak.jpg">
                                      <div class="card-body">
                                          <h6 class="card-title">KWT Memasak</h6>
                                          <a href="#" class="btn btn-outline-success btn-sm" >Lihat Detail</a>
                                      </div>
                                  </div>
                                  <div class="card-events">
                                      <img class="img-events img-fluid card-img-top2" alt="" src="img/event/penanaman_benih.jpg">
                                      <div class="card-body">
                                          <h6 class="card-title">Penanaman Benih Sayuran</h6>
                                          <a href="#" class="btn btn-outline-success btn-sm" >Lihat Detail</a>
                                      </div>
                                  </div>
                                  <div class="card-events">
                                      <img class="img-events img-fluid card-img-top2" alt="" src="img/event/panen_lele2.jpeg">
                                      <div class="card-body">
                                          <h6 class="card-title">Panen Lele KWT</h6>
                                          <a href="#" class="btn btn-outline-success btn-sm" >Lihat Detail</a>
                                      </div>
                                  </div>
                              </div>
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" data-aos-delay="300">
              <div class="tentang ps-0 ps-lg-4">
                  ...
                  <form action="/kwt" method="get">
                    ...
                    <button type="submit" class="more btn bg-transparent">
              ...
              <div id="carouselToga" class="carousel carousel-dark slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                      <div class="carousel-item active">
                          <div class="card-wrapper">
                              <div class="card-ingr" data-bs-toggle="modal" data-bs-target="#cardToga">
                                  <img class="card-img-top1 img-fluid" alt="" src="img/toga/jahe.jpg">
                              ...
                              <div class="card-ingr">
                                  <img class="card-img-top1 img-fluid" alt="" src="img/toga/sereh.jpg">
                                  <div class="card-body">
                              ...
                              <div class="card-ingr">
                                  <img class="card-img-top1 img-fluid" alt="" src="img/toga/tomat.jpg">
                                  <div class="card-body">
                      ...
                      <div class="carousel-item">
                          <div class="card-wrapper">
                              <div class="card-ingr">
                                  <img class="card-img-top1 img-fluid" alt="" src="img/toga/jeruk_purut.jpg">
                                  <div class="card-body">
                                      <h6 class="card-title">JERUK PURUT</h6>
                                  </div>
                              </div>
                              <div class="card-ingr">
                                  <img class="card-img-top1 img-fluid" alt="" src="img/toga/cabe_rawit.jfif">
                                  <div class="card-body">
                                      <h6 class="card-title">CABE RAWIT</h6>
                                  </div>
                              </div>
                              <div class="card-ingr">
                                  <img class="card-img-top1 img-fluid" alt="" src="img/toga/kencur.jfif">
                                  <div class="card-body">
              ...
              <div id="carouselProduk" class="carousel carousel-dark slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                      <div class="carousel-item active">
                          <div class="card-wrapper">
                              <div class="card-produk" data-bs-toggle="modal" data-bs-target="#cardProduk">
                                  <img class="img-produk img-fluid card-img-top1" alt="" src="img/produk/sambal.jpg">
                                  <div class="card-body-produk mt-3 mb-3">
                                      <h6 class="card-title">Sambal Sereh</h6>
                                      {{-- <a href="#" class="btn btn-outline-success btn-sm" >Selengkapnya</a> --}}
                                  </div>
                              </div>
                              <div class="card-produk">
                                  <img class="img-produk img-fluid card-img-top1" alt="" src="img/produk/puding.jpg">
                                  <div class="card-body-produk mt-3 mb-3">
                              ...
                              <div class="card-produk">
                                  <img class="img-produk img-fluid card-img-top1" alt="" src="img/produk/sabuns.jpg">
                                  <div class="card-body-produk">
                                      <h6 class="card-title mt-3 mb-3">Sabun Sereh</h6>
                                      {{-- <a href="#" class="btn btn-outline-success btn-sm" >Selengkapnya</a> --}}
                                  </div>
                              </div>
                              {{-- <div class="card-produk">
                      ...
                      <div class="carousel-item">
                        <div class="card-wrapper">
                            <div class="card-produk">
                                <img class="img-produk img-fluid card-img-top1" alt="" src="img/produk/jamu.jpg">
                                <div class="card-body-produk">
                                    <h6 class="card-title mt-3 mb-3">Jamu Kunyit Asam</h6>
                                    {{-- <a href="#" class="btn btn-outline-success btn-sm" >Selengkapnya</a> --}}
                                </div>
                            </div>
                        </div>
  ...
  <footer class="text-white text-center text-lg-start" style="background-color: #30704d;" id="kontak">
      <!-- Grid container -->
      <div class="container p-4 isian-db">
        <!--Grid row-->
        <div class="row">
          <!--Grid column-->
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
            ...
            <p>
                Jl. Bendung Colo Timur, RT.01/RW.03, Dusun II, Gupit, Kec. Nguter, Kabupaten Sukoharjo, Jawa Tengah 57571
            </p>
          </div>
          <!--Grid column-->
          <!--Grid column-->
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
              ...
              <p>
              Bu Endang - Ketua KWT : 0895-2143-5113
              </p>
          </div>
          <!--Grid column-->
        </div>
