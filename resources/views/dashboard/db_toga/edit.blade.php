...
@section('container')
    ...
    <div class="container-fluid isian-db table-style">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 my-3 border-bottom">
            <h4>Edit Data TOGA</h4>
        </div>

        {{-- deskripsi --}}
        <p class="mb-3">Mengedit data TOGA yang dibudidayakan oleh KWT Desa Gupit.</p>

        {{-- form --}}
        <div class="card shadow my-4 w-75">
            <div class="card-header py-2">
                <h6 class="my-2 bg-light table-name">Form Edit Data TOGA</h6>
            </div>
            <div class="card-body px-lg-5 mt-4">
                <form action="/dashboard/toga/{{ $items->id }}" enctype="multipart/form-data" method="post">
                    @method('put')
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user" type="text" id="latin_name" name="latin_name"
                                value="{{ old('latin_name',$items->latin_name) }}">
                            @error('latin_name')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
    ...
    <div class="mt-2 mb-5 mx-4 isian-db">
        <a href="/dashboard/toga" class="btn btn-outline-info mt-3 mb-5 small text-dark rounded"
