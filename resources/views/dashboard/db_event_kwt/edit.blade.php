...
@section('container')
    ...
    <div class="container-fluid isian-db table-style">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 my-3 border-bottom">
            <h4>Edit Data Kegiatan KWT</h4>
        </div>

        {{-- deskripsi --}}
        <p class="mb-3">Mengedit Data Kegiatan KWT Desa Gupit.</p>

        {{-- form --}}
        <div class="card shadow my-4 w-75">
            <div class="card-header py-2">
                <h6 class="my-2 bg-light table-name">Form Edit Data Kegiatan</h6>
            </div>
            <div class="card-body px-lg-5 mt-4">
                <form action="/dashboard/kwt_event/{{ $items->id }}" enctype="multipart/form-data" method="post">
                    @method('put')
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user" type="text" id="title" name="title"
                                value="{{ old('title',$items->title) }}" required autofocus>
                            @error('title')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user @error('waktu') is-invalid @enderror" type="date" id="waktu" name="waktu"
                                value="{{ old('waktu',$items->waktu) }}" required autofocus>
                            @error('waktu')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="mx-3">
                            ...
                            @enderror
                            <input id="body" type="hidden" name="body" value="{{ old('body',$items->body) }}">
