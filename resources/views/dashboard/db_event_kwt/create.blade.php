    ...
    <div class="container-fluid isian-db table-style">
        ...
        <div class="card shadow my-4 w-75">
            <div class="card-header py-2">
                <h6 class="my-2 bg-light table-name">Form Tambah Kegiatan</h6>
            </div>
            <div class="card-body px-lg-5 mt-4">
                <form action="/dashboard/kwt_event" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-primary text-white me-md-6 my-3" type="submit">Tambah Kegiatan</button>
                    </div>
                </form>
            </div>
        </div>
